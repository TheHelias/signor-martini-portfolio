module.exports = {
  ...
  // siteFBAppID: '',
  googleTagManagerID: process.env.GTM_ID || 'GTM-NTN6WT3',
  GA_TRACKING_ID: process.env.GA_TRACKING_ID || 'G-831DJTY2YP',
  disqusShortname: process.env.DISQUS_SHORTNAME || 'martiniakande',
